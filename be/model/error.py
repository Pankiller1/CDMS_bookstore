error_code = {
    ...
    526: "order_no_pay, order id{}",
    527: "order_no_shipped, order id{}",
    528: "order_already_received, order id{}",
}
...
def error_order_no_pay(order_id):
    return 526, error_code[526].format(order_id)


def error_order_no_shipped(order_id):
    return 527, error_code[527].format(order_id)


def error_order_already_received(order_id):
